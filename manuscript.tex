...
Functions can be provided through a method, and the parameters in the method refer to different particles in the system.
In this way, many-body potentials can also be described with methods with more than two parameters.
Functions that only updates every particle separately can also be described with a single parameter.
\autoref{lst:euler} displays how to implement a simple Euler integrator for \ac{MD}.
