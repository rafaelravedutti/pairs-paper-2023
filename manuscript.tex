...
Note there is a significant overhead for communication when using GPUs (compared to solving the problem in a single GPU), which can be attributed to the time spent transferrng data from the GPUs through the communication channels and then back to the other GPU.
