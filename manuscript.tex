...
\begin{figure*}[htb]
    \centering
    \subfigure[Linked Cells]{\label{fig:linked_cells}\includegraphics[width=0.25\textwidth]{fig1a_linked_cells.pdf}}
    \subfigure[Verlet Lists]{\label{fig:verlet_lists}\includegraphics[width=0.25\textwidth]{fig1b_verlet_lists.pdf}}
...
The Verlet Lists (see Figure~\ref{fig:verlet_lists}) constructs a list of neighbor particles for every particle, and this list can be created by using the Linked Cells structure, evaluating the distances \RMchange{between} particles within close bins and then using the distance to determine whether such particles should be added into the list.
...
\begin{figure*}[htb]
  \centering
  \includegraphics[width=0.6\textwidth]{fig2_pairs_overview.png}
...
\begin{figure*}[htb]
  \centering
  \includegraphics[width=0.75\textwidth]{fig3_pairs_architecture.pdf}
...
\begin{figure*}[htb]
  \centering
  \includegraphics[width=0.75\textwidth]{fig4_pairs_ir.pdf}
...
In GPUs, however, this should lead to better execution since threads are not halted waiting for the surrounding neighbor cells to be computed when the amount of particles \RMchange{between} them is different.
...
Due to its multiple shapes and dynamics that consists of many interactions \RMchange{between} spheres and half-spaces, it should provide a good reference for DEM simulations.
...
\begin{figure*}[tb]
    \centering
    \subfigure[t = 0]{\label{fig:md_ts0}\includegraphics[width=0.32\textwidth]{fig5a_md_ts0.png}}
    \subfigure[t = 100]{\label{fig:md_ts100}\includegraphics[width=0.32\textwidth]{fig5b_md_ts100.png}}
    \subfigure[t = 200]{\label{fig:md_ts200}\includegraphics[width=0.32\textwidth]{fig5c_md_ts200.png}}
...
\begin{figure*}[tb]
    \centering
    \subfigure[t = 0]{\label{fig:dem_ts0}\includegraphics[width=0.48\textwidth]{fig6a_dem_ts0.png}}
    \subfigure[t = 2000]{\label{fig:dem_ts2000}\includegraphics[width=0.48\textwidth]{fig6b_dem_ts2000.png}}
    \vskip\baselineskip
    \subfigure[t = 4000]{\label{fig:dem_ts4000}\includegraphics[width=0.48\textwidth]{fig6c_dem_ts4000.png}}
    \subfigure[t = 10000]{\label{fig:dem_ts10000}\includegraphics[width=0.48\textwidth]{fig6d_dem_ts10000.png}}
...
For \RMchange{the} \ac{MD} case\RMchange{s}, we use the Verlet Lists algorithm as it is the standard one for such simulations.
...
We use the simple \ac{LJ} potential (as shown in \autoref{lst:pairslj}) to calculate the force contributions \RMchange{between} atoms.
...
Based on our results, it is clear that P4IRS is able to generate scalable code on modern CPU clusters, but problems that are not too homogeneous may need proper mechanisms for balancing the workload \RMchange{between} different MPI ranks.
