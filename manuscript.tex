...
\begin{itemize}
    ...
    \item \emph{exchange:} send particles that overlap the current rank's domain, it becomes a local particle in the neighbor rank; all properties except volatiles are sent.
\end{itemize}
...
\vspace{-2ex}
\centering
\label{fig:md_single_gpu_results}
\end{figure}
