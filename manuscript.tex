...
P4IRS\footnote{\url{https://i10git.cs.fau.de/software/pairs}} is a stand-alone compiler and domain-specific language for particle simulations which aims at generating optimized code for different target hardwares.
