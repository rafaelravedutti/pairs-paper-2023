...
An important aspect of DSLs is to be able to use domain knowledge for their compiler transformations, thus enabling code optimizations that may not be detected by general purpose compilers.
