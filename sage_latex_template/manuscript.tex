...
\author{Rafael Ravedutti Lucio Machado\affilnum{1} and Jan Eitzinger\affilnum{1} and Harald Köstler\affilnum{1}}
...
To combine flexibility and optimal performance, we introduce P4IRS, an intermediate representation and compiler for particle simulations which aims at delivering good performance.
