...
For \ac{MD} simulations, we show results with the Verlet Lists optimization strategy since it is widely employed the field, while for \ac{DEM} we display results with the Linked Cells data-structure because particles are rigid bodies and actually need to be in contact for contributions to be computed, hence there are no significant advantages of using Verlet Lists.
...
\bibitem[Ravedutti Lucio Machado~R et al.(2023)]{mdbench1}
...
\bibitem[Ravedutti Lucio Machado~R et al.(2023)b]{mdbench2}
